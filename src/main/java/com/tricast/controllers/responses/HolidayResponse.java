...
public class HolidayResponse implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((accountRealName == null) ? 0 : accountRealName.hashCode());
		result = prime * result
	...
	public String toString() {
		return "HolidayResponse [id=" + id + ", accountId=" + accountId
				+ ", accountRealName=" + accountRealName + ", fromDay="
				+ fromDay + ", toDay=" + toDay + ", actualDayCount="
